...
package com.example.hellojni.Repos;
...
public final class Repo extends Table {
  ...
  public long size() { int o = __offset(36); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addSize(FlatBufferBuilder builder, long size) { builder.addLong(16, size, 0L); }
